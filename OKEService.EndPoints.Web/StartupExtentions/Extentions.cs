...
using OKEService.Utilities.Services.DependentyInjection;
...
namespace OKEService.EndPoints.Web.StartupExtentions
{
    public static class Extentions
    {
        ...
        public static IServiceCollection AddOKEServiceDependencies(this IServiceCollection services,
            params string[] assemblyNamesForSearch)
        {

            var assemblies = GetAssemblies(assemblyNamesForSearch);
            services.AddApplicationServices(assemblies).AddDataAccess(assemblies).AddOKEServices(assemblies).AddCustomeDepenecies(assemblies);
            return services;
        }
