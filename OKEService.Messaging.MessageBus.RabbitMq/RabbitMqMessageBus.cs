...
using OKEService.Utilities.Extentions;
...
namespace OKEService.Messaging.MessageBus.RabbitMq
{
    public class RabbitMqMessageBus : IMessageBus
    {
        ...
        public RabbitMqMessageBus(OKEServiceConfigurationOptions configuration, IJsonSerializer jsonSerializer, IMessageConsumer messageConsumer)
        {
